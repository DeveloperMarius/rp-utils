...
class ForeignKeyProperty
{
     ...
     */
    public function __construct(private readonly ?string $references_table = null, private readonly ?string $references_column = 'id', #[ExpectedValues([null, 'CASCADE'])] private readonly ?string $on_delete = null, #[ExpectedValues([null, 'CASCADE'])] private readonly ?string $on_update = null){}
